...
import { FBApp, FBAppDatabase } from '../../client/src/firebaseInit.js'
...
FirebaseWrapper.prototype.init = function(config) {
  ...
  this.firebase = FBApp //firebase.initializeApp(config);
...
FirebaseWrapper.prototype.updatePosition = function(coords) {
...
FirebaseWrapper.prototype.clearLocalWorld = function() {
  // this.database.child(this.userId).child(this.world).child('entities').on('child_removed', function (data) {
  //   handler(data.key);
  // });
};
